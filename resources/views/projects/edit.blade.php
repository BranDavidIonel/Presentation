        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form role="form" method="POST" action="{{route('projects.update',$project->id)}}" enctype='multipart/form-data'>
                            @method('put')
                            @csrf
                            <div class="mb-3">
                                <label for="title" class="form-label">Title</label>
                                <input value="{{$project->title}}" type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" aria-describedby="title">
                            ...
                            <div class="mb-3">
                                ...
                                <img style="max-height:100px;" src="{{$project->imagePath()}}" />
                                @error('logo')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{$project->link_app}}" type="text" class="form-control  @error('app_link') is-invalid @enderror" name="app_link" id="app_link" aria-describedby="app_link">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{$project->link_github}}"type="text" class="form-control @error('github_link') is-invalid @enderror" name="github_link" id="github_link" aria-describedby="github_link">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{$tags}}" type="text" class="form-control @error('tags') is-invalid @enderror" name="tags" id="tags" aria-describedby="tags">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{$project->order}}" type="number" class="form-control @error('order') is-invalid @enderror" name="order" id="order" aria-describedby="order" value="0">
